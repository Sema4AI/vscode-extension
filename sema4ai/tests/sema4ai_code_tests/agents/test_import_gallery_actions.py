...
def test_import_gallery_actions(data_regression, tmpdir):
    import os
    from pathlib import Path

    from sema4ai_code.agents import gallery_actions

    gallery_actions = gallery_actions.GalleryActions(example_metadata)
