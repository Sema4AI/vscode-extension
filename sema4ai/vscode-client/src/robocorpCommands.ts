...
export const SEMA4AI_ACTION_SERVER_PACKAGE_METADATA = "sema4ai.actionServerPackageMetadata";  // Create Action Package OpenAPI Spec (metadata.json)
export const SEMA4AI_ACTION_SERVER_PACKAGE_METADATA_INTERNAL = "sema4ai.actionServerPackageMetadata.internal";  // Create Action Package OpenAPI Spec (metadata.json) (internal)
export const SEMA4AI_OPEN_ACTION_PACKAGE_METADATA = "sema4ai.openActionPackageMetadata";  // Open the Action Package OpenAPI Spec (metadata.json)