...
export const SEMA4AI_REFRESH_AGENT_PACKAGES_VIEW = "sema4ai.refreshAgentPackagesView";  // Refresh Agent Packages view
...
export const SEMA4AI_LOCAL_LIST_AGENT_PACKAGES_INTERNAL = "sema4ai.localListAgentPackages.internal";  // Lists the Agent Packages currently available in the workspace