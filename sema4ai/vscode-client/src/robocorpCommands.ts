...
export const SEMA4AI_AGENT_SERVER_DOWNLOAD_INTERNAL = "sema4ai.agentServerDownload.internal";  // Downloads the Agent Server (internal)
...
export const SEMA4AI_AGENT_SERVER_VERSION_INTERNAL = "sema4ai.agentServerVersion.internal";  // Get the Agent Server's version (internal)