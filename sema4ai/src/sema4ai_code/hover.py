...
from sema4ai_ls_core.lsp import HoverTypedDict, MarkupContent, MarkupKind
from sema4ai_ls_core.protocols import IDocument

from sema4ai_code.vendored_deps.package_deps._conda_deps import CondaDepInfo
...
def _create_conda_requirements_desc_parts(
    ...
    from sema4ai_code.vendored_deps.package_deps.conda_impl.conda_match_spec import (
        parse_spec_str,
    )
