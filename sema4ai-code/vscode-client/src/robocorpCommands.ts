...
export const ROBOCORP_CREATE_RCC_TERMINAL_TREE_SELECTION = "robocorp.rccTerminalCreateRobotTreeSelection";  // Open terminal with Package Python environment
...
export const ROBOCORP_CLEAR_ENV_AND_RESTART = "robocorp.clearEnvAndRestart";  // Clear Robocorp (RCC) environments and restart Sema4.ai Code
export const ROBOCORP_SHOW_OUTPUT = "robocorp.showOutput";  // Show Sema4.ai Code > Output logs
