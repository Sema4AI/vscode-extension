...
export function registerDebugger() {
    ...
    debug.registerDebugAdapterDescriptorFactory("sema4ai-code", {
    ...
    debug.registerDebugConfigurationProvider("sema4ai-code", new RobocorpCodeDebugConfigurationProvider());
}
