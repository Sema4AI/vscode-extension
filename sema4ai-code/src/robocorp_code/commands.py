...
ROBOCORP_CLEAR_ENV_AND_RESTART = "robocorp.clearEnvAndRestart"  # Clear Robocorp (RCC) environments and restart Sema4.ai Code
ROBOCORP_SHOW_OUTPUT = "robocorp.showOutput"  # Show Sema4.ai Code > Output logs
