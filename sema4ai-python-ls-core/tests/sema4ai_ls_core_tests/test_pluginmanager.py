...
import pytest
from sema4ai_ls_core.pluginmanager import PluginManager, InstanceAlreadyRegisteredError
from sema4ai_ls_core.protocols import Protocol
...
def test_plugins():
    from sema4ai_ls_core.pluginmanager import NotRegisteredError
...
def test_inject():
    from sema4ai_ls_core.pluginmanager import inject
