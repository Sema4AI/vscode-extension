...
import itertools
from sema4ai_ls_core.core_log import get_logger, get_log_level
import json
...
def reader_thread(
    ...
    from sema4ai_ls_core.debug_adapter_core.dap import dap_base_schema

    from sema4ai_ls_core.debug_adapter_core.dap import (
